...
//Nested is within the 'myFunction' function along with the internal variable. Using closure the nested function reaches outside of itself and grabs the internal variable.
...
animalNames(zooAnimals);
  ...
  */
  ...
  function lowerCaseNames(arr){
    const lowerCaseAnimals = arr.map(function(item){
...
lowerCaseNames(zooAnimals);
  ...
  */
  ...
  function lowPopulationAnimals(arr){
    const lonely = arr.filter(function(item){
  ...
  */
  ...
  function USApop(arr){
    const totalPopulation = arr.reduce(function(accumulator, item){
